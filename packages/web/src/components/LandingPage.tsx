    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
          ...
          <a
            href="https://github.com/cloudcwfranck/aegis"
            style={{
              color: '#000000',
              textDecoration: 'none',
              fontSize: '0.95rem',
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ marginBottom: '4rem' }}>
            ...
            >
              ...
              platform that goes beyond simple scanning by providing automated
          ...
          >
            ...
            >
              ...
              >
                ...
                <path
                  d="M5 10 L12 15 L20 8 L28 12 L35 6"
                  stroke="white"
                  strokeWidth="2"
                  fill="none"
                  strokeLinecap="round"
          ...
          >
            ...
            <div>
              ...
              >
                <path
                  d="M6 18 Q6 6 18 6 Q30 6 30 18 Q30 30 18 30 Q6 30 6 18"
                  stroke="white"
                  strokeWidth="2"
                  fill="none"
                />
            ...
            <div>
              ...
              >
                Work with Syft, Grype, and any SPDX-compatible tools. Export to
                OSCAL for continuous monitoring reporting.
              </p>
            </div>
            ...
            <div>
              ...
              >
                <path
                  d="M6 18 L12 12 L18 18 L24 12 L30 18"
                  stroke="white"
                  strokeWidth="2"
                  fill="none"
                  strokeLinecap="round"
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          >
            ...
            <div>
              ...
              >
                Deploy and monitor compliance with open infrastructure, free
                from vendor lock-in
              </p>
              <Link
                to="/upload"
              ...
              >
                ...
                >
                  <div style={{ fontWeight: '600', color: '#000000' }}>
                    Generated by Aegis DevSecOps Platform
                  </div>
                  <div>v0.1.0</div>
                </div>
                <div
      ...
      >
        ...
        <p
          style={{ marginTop: '0.5rem', fontSize: '0.8rem', color: '#888888' }}
        >
          Not affiliated with or endorsed by any government entity. Built for
